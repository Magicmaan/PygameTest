...
def main():
    ...
    while game.running:
        ...
        # Camera smooth following using linear interpolation
        target_camera_x = -player.position.x + game.screen.get_width()/2
        game.camera.x = game.camera.x + (target_camera_x - game.camera.x) * 0.15
        game.camera.y = 0
